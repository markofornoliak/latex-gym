...
export const projects:LearningProject[]=[
  ...
  },
  {
    ...
    stages:[
      ...
      {id:'stage-8',title:'8. Библиография',objective:'Перенести источники в .bib-модель и цитировать по ключам.',requirements:['biblatex','addbibresource','cite','printbibliography'],starterCode:'\\usepackage[backend=biber]{biblatex}\n\\addbibresource{references.bib}\n\nPrevious work~\\cite{knuth1984} established the approach.\n\\printbibliography'},
