...
export function sanitizePersistedState(value:unknown){if(!isRecord(value))return {};const parsed=parseProgressImport(JSON.stringify(value));return parsed.ok?parsed.value:{};}
