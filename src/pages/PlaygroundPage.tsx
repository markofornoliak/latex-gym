...
export function PlaygroundPage(){
  ...
  const updateSource=(value:string)=>{setSource(value);if(result)setResult(null);if(compileState!=='ready')setCompileState('ready');};
