...
export function OnboardingPage() {
  ...
  useEffect(()=>{
    ...
    if(step===3&&feedback)return;
    requestAnimationFrame(()=>stageHeading.current?.focus({preventScroll:true}));
  },[step,finished,feedback]);
